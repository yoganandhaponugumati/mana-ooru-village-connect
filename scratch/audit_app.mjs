...
const commonHooks = ['useState', 'useEffect', 'useRef', 'useMemo', 'useCallback', 'useContext', 'useId', 'useLayoutEffect'];
...
if (missingImports.length === 0) {
  console.log('✅ AUDIT PASSED: No missing imports or undefined hooks found in any route or component!');
} else {
