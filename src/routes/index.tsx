    ...
    <div className="village-site-bg min-h-screen text-foreground">
      ...
      <header className="relative min-h-screen overflow-hidden bg-[#06140d]">
        ...
        <div className="relative z-20 mx-auto max-w-7xl px-4 pt-24 sm:px-6">
          ...
          {/* FULL-WIDTH HERO SHOWCASE CARD SPANNING 100% CONTAINER WIDTH (No empty space!) */}
          <motion.div
              ...
              <div className="space-y-4 text-left">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-2">
                  ...
                  >
                    ...
                    <span>Watch Telugu Video Guide (తెలుగు వాయిస్ గైడ్)</span>
                  </button>
              ...
              <div className="grid grid-cols-2 gap-2.5 text-left">
                <div className="rounded-2xl border border-white/15 bg-white/10 p-3 backdrop-blur-md space-y-1 transition hover:bg-white/15">
                  <div className="flex items-center gap-2 text-emerald-300 font-bold text-xs">
                    ...
                    <span>గ్రామ నోటీసులు</span>
                  </div>
                  <p className="text-[11px] text-white/80 font-medium leading-tight">
                    పంచాయతీ ప్రచారాలు & అధికారిక గ్రామ సమాచారం
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-white/15 bg-white/10 p-3 backdrop-blur-md space-y-1 transition hover:bg-white/15">
                  ...
                  <p className="text-[11px] text-white/80 font-medium leading-tight">
                    రోడ్లు, కరెంట్ సమస్యలపై ఫొటో ప్రూఫ్‌తో ఫిర్యాదు
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-white/15 bg-white/10 p-3 backdrop-blur-md space-y-1 transition hover:bg-white/15">
                  <div className="flex items-center gap-2 text-amber-300 font-bold text-xs">
                    ...
                    <span>ప్రభుత్వ పథకాలు</span>
                  </div>
                  <p className="text-[11px] text-white/80 font-medium leading-tight">
                    రైతు భరోసా, పీఎం కిసాన్ & ఉచిత డిజిటల్ సేవలు
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-white/15 bg-white/10 p-3 backdrop-blur-md space-y-1 transition hover:bg-white/15">
                  <div className="flex items-center gap-2 text-cyan-300 font-bold text-xs">
                    ...
                    <span>కూలీలు & పొలాలు</span>
                  </div>
                  <p className="text-[11px] text-white/80 font-medium leading-tight">
                    దళారులు లేకుండా నేరుగా ఫోన్ చేసి మాట్లాడండి
                  </p>
                </div>
              </div>
            </div>
