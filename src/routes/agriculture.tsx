...
const MANDI_RATES = [
  { crop: "Paddy (వరి - Grade A)", price: "₹2,320 / Quintal", trend: "+₹50", status: "High Demand", color: "text-emerald-600 bg-emerald-50 border-emerald-200" },
  { crop: "Cotton (ప్రత్తి - Long Staple)", price: "₹7,450 / Quintal", trend: "+₹120", status: "Stable", color: "text-amber-600 bg-amber-50 border-amber-200" },
  { crop: "Chilli (ఎర్ర మిరప - Teja)", price: "₹18,500 / Quintal", trend: "+₹300", status: "Peak Price", color: "text-red-600 bg-red-50 border-red-200" },
  { crop: "Maize (మొక్కజొన్న)", price: "₹2,150 / Quintal", trend: "-₹20", status: "Normal", color: "text-blue-600 bg-blue-50 border-blue-200" },
];

const MACHINERY_RENTALS = [
  { name: "Srinivas Rao (Mahindra 575 DI)", type: "Tractor & Rotavator", rate: "₹900 / Hour", phone: "9848012345", location: "Main Road, Ward 2" },
  { name: "Venkateswarlu Harvesters", type: "Paddy Combine Harvester", rate: "₹2,400 / Hour", phone: "9848056789", location: "Near Railway Gate" },
  { name: "Kallur Agri Tools", type: "Power Tiller & Sprayers", rate: "₹350 / Day", phone: "9848099887", location: "Mandal Center" },
];

const AGRI_SHOPS = [
  { name: "Sri Lakshmi Fertilisers & Seeds", owner: "Rambabu", phone: "9848011223", items: "Urea, DAP, Pesticides, Certified Seeds", location: "Bazar Street" },
  { name: "Rythu Seva Kendra", owner: "Agri Dept Officer", phone: "0841-23456", items: "Subsidized Seeds & Bio Fertilisers", location: "Gram Panchayat Office" },
];
    ...
    >
      <div className="space-y-8">
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-display text-xl font-bold text-foreground flex items-center gap-2">
              <TrendingUp className="size-5 text-emerald-600" /> Live Mandi Crop Rates (మార్కెట్ ధరలు)
            </h2>
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-display text-xl font-bold text-foreground flex items-center gap-2">
              <Tractor className="size-5 text-primary" /> Machinery & Harvester Rental (వరి కోత & ట్రాక్టర్లు)
            </h2>
            <Link
              to="/services"
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <SurfaceCard className="p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="font-display text-lg font-bold text-foreground">Rythu Bharosa & Subsidies</h3>
                <p className="text-xs text-muted-foreground">Government financial assistance & crop insurance</p>
              </div>
            </div>
            ...
            <ul className="space-y-3 text-xs text-muted-foreground mb-6">
              <li className="flex items-start gap-2">
                ...
                <span><strong>Rythu Bharosa / PM-Kisan:</strong> ₹13,500 annual investment support directly to farmer bank accounts.</span>
              </li>
              <li className="flex items-start gap-2">
                <ShieldCheck className="size-4 text-emerald-500 shrink-0 mt-0.5" />
                <span><strong>Subsidized Seeds:</strong> 50% subsidy on Paddy, Groundnut, and Pulses seeds at Gram Panchayat.</span>
              </li>
            </ul>
          ...
          <SurfaceCard className="p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="font-display text-lg font-bold text-foreground">Soil Testing & Fertilizer Shops</h3>
                <p className="text-xs text-muted-foreground">Free soil health card & certified inputs</p>
              </div>
            </div>
              ...
              {AGRI_SHOPS.map((shop, idx) => (
                <div key={idx} className="p-3 rounded-xl bg-muted/40 border border-border/50 text-xs">
                  ...
                  <div className="mt-2 flex items-center justify-between text-[11px]">
                    ...
                    <a href={`tel:${shop.phone}`} className="font-bold text-primary hover:underline">
                      📞 {shop.phone}
                    </a>
                  </div>
                </div>
