...
export function PrivacyPolicyPage() {
  return (
    <PageLayout
      ...
      subtitle="Transparent documentation on how GramMitra collects, secures, and honors your personal village data in compliance with Google Play Store rules."
      ...
      <div className="mx-auto max-w-4xl space-y-10">
        <SurfaceCard className="p-6 sm:p-8 border-primary/20 bg-gradient-to-br from-card via-card to-primary/5">
          ...
          <p className="mt-6 text-sm sm:text-base leading-7 text-muted-foreground">
            Welcome to <strong className="text-foreground">GramMitra</strong> (the
            ...
            using GramMitra, you trust us with your local identity. We never sell your personal data
        ...
        <SurfaceCard className="p-6 sm:p-8">
          ...
          <p className="mt-3 text-sm sm:text-base leading-7 text-muted-foreground">
            ...
            <br />
            <br />
            Because GramMitra operates as a{" "}
        ...
        <SurfaceCard className="p-6 sm:p-8">
          ...
          <p className="mt-3 text-sm leading-6 text-muted-foreground">
            ...
            or your personal data across the GramMitra network, please reach out directly to our
            dedicated support desk:
          </p>
          <div className="mt-4 rounded-2xl bg-muted/60 p-4 text-sm space-y-1">
            <p>
              <strong className="text-foreground">Grievance Email:</strong> privacy@grammitra.org
            </p>
            <p>
              <strong className="text-foreground">Support Desk:</strong> hello@grammitra.org
            </p>
            <p>
