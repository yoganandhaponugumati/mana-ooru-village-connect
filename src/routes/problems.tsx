...
export const Route = createFileRoute("/problems")({
  head: () => ({ meta: [{ title: "Citizen Problem Desk & Civic Accountability — GramMitra" }] }),
...
function ProblemsPage() {
  ...
  const shareToWhatsApp = (title: string, desc: string, loc: string) => {
    ...
    const msg = `🚨 *GramMitra Citizen Issue Reported*\n*Problem:* ${title}\n*Location:* ${loc}\n*Details:* ${desc}\n\nSupport this civic report here: ${url}`;
                ...
                >
                  ...
                  <div className="flex flex-col flex-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-1.5 mb-1.5">
                      ...
                      {item.imageUrl && (
                        <span className="inline-flex items-center gap-1 rounded-md bg-purple-100 dark:bg-purple-950/40 text-purple-800 dark:text-purple-300 px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wider">
                          📷 Photo Proof
                        </span>
                      )}
                      <span
                    ...
                    <div className="mt-1 flex-1">
                      ...
                      <button className="text-[10px] font-bold text-primary mt-0.5 hover:underline flex items-center gap-0.5">
                        Read full details <ArrowRight className="size-3" />
                      </button>
                    </div>
                    ...
                    {isResolved ? (
                      ...
                      item.officialResponse && (
                        <div className="mt-2.5 rounded-xl border border-primary/20 bg-primary/5 p-2 text-[10px] text-left">
                          ...
                          <p className="mt-1 truncate text-clay font-medium">
                            {item.officialResponse}
                          </p>
                        </div>
                      )
                    ...
                    <div className="mt-3.5 bg-muted/40 dark:bg-zinc-800/20 rounded-2xl p-3 border border-border/40 relative overflow-hidden">
                      ...
                      <div className="relative flex items-center justify-between w-full mt-2.5 px-3">
                        ...
                        <div className="mt-4 rounded-2xl border-2 border-primary/50 bg-primary/5 dark:bg-zinc-900/90 p-4 space-y-3.5 shadow-md">
                          ...
                          <div>
                            ...
                            <p className="text-[11px] text-muted-foreground mb-1.5 leading-4">
                              If Sarpanch cannot solve right now (e.g., waiting for funds or
                              district approval), explain clearly. If verified & resolved, describe
