...
const dictionary = {
  en: {
    ...
    workersSubtitle:
      "Find local farm laborers, masons, plumbers, electricians, and skilled workers.",
    landTitle: "Agricultural Land & Farmland Lease",
    landSubtitle:
      "Direct listings for farmland lease, land sales, and agricultural plots in your village.",
    ...
    servicesSubtitle:
      "Tractor rental, harvester services, borewell repair, and local equipment hire.",
    problemsTitle: "Citizen Grievances & Civic Issues",
    problemsSubtitle:
      "Report public water, electricity, and road issues directly to the Gram Panchayat.",
    ...
    governmentSubtitle:
      "15th Finance Commission funds, NREGS project tracking, and Panchayat expenditure.",
  },
  te: {
    home: "హోమ్",
    timeline: "టైమ్‌లైన్",
    ...
    workersSubtitle:
      "వ్యవసాయ కూలీలు, తాపీ మేస్త్రీలు, ప్లంబర్లు, ఎలక్ట్రీషియన్లు మరియు నైపుణ్యం కలిగిన స్థానిక పనివారి జాబితా.",
    ...
    marketplaceSubtitle:
      "ధాన్యం, పశువులు, యంత్రాలు మరియు స్థానిక ఉత్పత్తుల సూటి అమ్మకాలు & కొనుగోళ్లు.",
    ...
    problemsSubtitle:
      "నీటి సమస్యలు, విద్యుత్ కోతలు, రోడ్ల పరిస్థితిపై సర్పంచ్ & పంచాయతీకి ప్రత్యక్ష ఫిర్యాదు.",
    noticesTitle: "గ్రామ పంచాయతీ ప్రకటనలు & సర్పంచ్ పనులు",
    noticesSubtitle:
      "సర్పంచ్ గారి అధికారిక ప్రకటనలు, గ్రామాభివృద్ధి పనుల పురోగతి మరియు పంచాయతీ నోటీసులు.",
    healthTitle: "ఆరోగ్య సేవలు & రక్తదాతలు",
    healthSubtitle:
      "అత్యవసర రక్తదాతలు, ప్రాథమిక ఆరోగ్య కేంద్రాలు (PHC) మరియు ఆశా కార్యకర్తల సమాచారం.",
    ...
    governmentSubtitle:
      "15వ ఆర్థిక సంఘం నిధులు, ఉపాధి హామీ ప్రాజెక్టులు మరియు గ్రామాభివృద్ధి వ్యయం.",
  },
  hi: {
    home: "होम",
    timeline: "टाइमलाइन",
...
export function useVillagePreferences() {
  const initialPref: StoredPreferences = {
    language: "te",
