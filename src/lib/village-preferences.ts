...
const dictionary = {
  en: {
    ...
    welcomeToGramMitra: "Welcome to GramMitra",
    ...
    transport: "Transport",
    schemes: "Schemes",
    workersTitle: "Agricultural & Skilled Workers",
    workersSubtitle: "Find local farm laborers, masons, plumbers, electricians, and skilled workers.",
    landTitle: "Agricultural Land & Farmland Lease",
    landSubtitle: "Direct listings for farmland lease, land sales, and agricultural plots in your village.",
    marketplaceTitle: "Village Marketplace & Farm Produce",
    marketplaceSubtitle: "Buy & sell crops, livestock, farm machinery, seeds, and local goods.",
    servicesTitle: "Village Services & Equipment Hire",
    servicesSubtitle: "Tractor rental, harvester services, borewell repair, and local equipment hire.",
    problemsTitle: "Citizen Grievances & Civic Issues",
    problemsSubtitle: "Report public water, electricity, and road issues directly to the Gram Panchayat.",
    noticesTitle: "Panchayat Notices & Development Works",
    noticesSubtitle: "Official Sarpanch announcements, urgent alerts, and development progress.",
    healthTitle: "Health Services & Blood Donors",
    healthSubtitle: "Emergency blood donors directory, PHC centers, and local healthcare workers.",
    schemesTitle: "Government Welfare Schemes",
    schemesSubtitle: "Rythu Bandhu, Aasara pensions, NREGS work, and eligibility details.",
    weatherTitle: "Live Village Weather",
    weatherSubtitle: "Local temperature, rain forecast, humidity, and farming weather alerts.",
    governmentTitle: "Village Budget & Financial Transparency",
    governmentSubtitle: "15th Finance Commission funds, NREGS project tracking, and Panchayat expenditure.",
  },
  te: {
    home: "హోమ్",
    timeline: "టైమ్‌లైన్",
    ...
    transport: "రవాణా",
    schemes: "పథకాలు",
    workersTitle: "గ్రామ కూలీలు & నైపుణ్య కార్మికులు",
    workersSubtitle: "వ్యవసాయ కూలీలు, తాపీ మేస్త్రీలు, ప్లంబర్లు, ఎలక్ట్రీషియన్లు మరియు నైపుణ్యం కలిగిన స్థానిక పనివారి జాబితా.",
    landTitle: "వ్యవసాయ భూములు & కౌలు ప్లాట్లు",
    landSubtitle: "వ్యవసాయ భూమి కౌలుకు ఇవ్వడం, కొనడం లేదా అమ్మడం కోసం స్థానిక రైతుల ప్రకటనలు.",
    marketplaceTitle: "గ్రామ సంత & రైతు ఉత్పత్తులు",
    marketplaceSubtitle: "ధాన్యం, పశువులు, యంత్రాలు మరియు స్థానిక ఉత్పత్తుల సూటి అమ్మకాలు & కొనుగోళ్లు.",
    servicesTitle: "గ్రామ సేవలు & యంత్రాల అద్దె",
    servicesSubtitle: "ట్రాక్టర్లు, హార్వెస్టర్లు, బోరు బావుల సేవలు మరియు స్థానిక యంత్రాల అద్దె.",
    problemsTitle: "గ్రామ సమస్యలు & పౌర సమాచారం",
    problemsSubtitle: "నీటి సమస్యలు, విద్యుత్ కోతలు, రోడ్ల పరిస్థితిపై సర్పంచ్ & పంచాయతీకి ప్రత్యక్ష ఫిర్యాదు.",
    noticesTitle: "గ్రామ పంచాయతీ ప్రకటనలు & సర్పంచ్ పనులు",
    noticesSubtitle: "సర్పంచ్ గారి అధికారిక ప్రకటనలు, గ్రామాభివృద్ధి పనుల పురోగతి మరియు పంచాయతీ నోటీసులు.",
    healthTitle: "ఆరోగ్య సేవలు & రక్తదాతలు",
    healthSubtitle: "అత్యవసర రక్తదాతలు, ప్రాథమిక ఆరోగ్య కేంద్రాలు (PHC) మరియు ఆశా కార్యకర్తల సమాచారం.",
    schemesTitle: "ప్రభుత్వ సంక్షేమ పథకాలు",
    schemesSubtitle: "రైతు బంధు, ఆసరా పెన్షన్లు, ఉపాధి హామీ పథకాల వివరాలు మరియు దరఖాస్తు విధానం.",
    weatherTitle: "స్థానిక గ్రామ వాతావరణం",
    weatherSubtitle: "ఉష్ణోగ్రత, వర్షపాతం మరియు వ్యవసాయ వాతావరణ హెచ్చరికలు.",
    governmentTitle: "గ్రామ పంచాయతీ బడ్జెట్ & నిధులు",
    governmentSubtitle: "15వ ఆర్థిక సంఘం నిధులు, ఉపాధి హామీ ప్రాజెక్టులు మరియు గ్రామాభివృద్ధి వ్యయం.",
  },
  hi: {
    home: "होम",
    timeline: "टाइमलाइन",
    ...
    welcomeToGramMitra: "GramMitra में आपका स्वागत है",
...
async function fetchLiveWeather(
  ...
  const searchTerms = [profile.village, profile.mandal, profile.district].filter(Boolean);
  ...
  for (const term of first ? [] : searchTerms) {
    ...
    const ranked = results
      .map((result) => {
        ...
        if (profile.district && admin2Val.includes(profile.district.toLowerCase().trim()))
          score += 2;
